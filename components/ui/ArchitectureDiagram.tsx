    ...
    <div className="my-8">
      ...
      <div className="rounded-[var(--radius-md)] border border-border bg-bg-secondary p-4 md:p-6 overflow-x-auto">
        ...
        >
          ...
          <text x="95" y="95" textAnchor="middle" className="fill-[var(--text-primary)]" fontFamily="var(--font-inter)" fontSize="11" fontWeight="600">SIMULATION GROUPS</text>
          <rect x="38" y="108" width="114" height="30" rx="4" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="95" y="128" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="10">Sim 1</text>
          <rect x="38" y="146" width="114" height="30" rx="4" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="95" y="166" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="10">Sim 2</text>
          <rect x="38" y="184" width="114" height="30" rx="4" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="95" y="204" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="10">Sim N</text>

          {/* ═══ NODE 2: ACTORS ═══ */}
          <rect x="240" y="85" width="160" height="130" rx="8" className="stroke-[var(--border-color)] fill-[var(--bg-elevated)]" strokeWidth="1.5" />
          <text x="320" y="110" textAnchor="middle" className="fill-[var(--text-primary)]" fontFamily="var(--font-inter)" fontSize="11" fontWeight="600">ACTORS</text>
          <text x="320" y="126" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="9">100+ CPU workers</text>
          <rect x="262" y="138" width="34" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="279" y="154" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">CPU</text>
          <rect x="302" y="138" width="34" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="319" y="154" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">CPU</text>
          <rect x="342" y="138" width="34" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="359" y="154" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">CPU</text>
          <rect x="262" y="168" width="34" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="279" y="184" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">CPU</text>
          <rect x="302" y="168" width="34" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="319" y="184" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">CPU</text>
          <rect x="342" y="168" width="34" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="359" y="184" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">CPU</text>
          ...
          <text x="555" y="118" textAnchor="middle" className="fill-[var(--text-primary)]" fontFamily="var(--font-inter)" fontSize="11" fontWeight="600">REPLAY MEMORY</text>
          <text x="555" y="134" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="9">sharded</text>
          <rect x="492" y="148" width="36" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="510" y="164" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">S1</text>
          <rect x="536" y="148" width="36" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="554" y="164" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">S2</text>
          <rect x="580" y="148" width="36" height="24" rx="3" className="stroke-[var(--border-color)] fill-[var(--bg-primary)]" strokeWidth="1" />
          <text x="598" y="164" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">S3</text>
          <text x="555" y="192" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">prioritized sampling</text>

          {/* ═══ NODE 4: GPU LEARNER ═══ */}
          <rect x="710" y="100" width="130" height="100" rx="8" className="stroke-[var(--accent)] fill-[var(--bg-elevated)]" strokeWidth="2" />
          <text x="775" y="125" textAnchor="middle" className="fill-[var(--text-primary)]" fontFamily="var(--font-inter)" fontSize="11" fontWeight="600">GPU LEARNER</text>
          <rect x="730" y="140" width="90" height="28" rx="4" className="stroke-[var(--accent)] fill-[var(--accent-soft)]" strokeWidth="1" />
          <text x="775" y="158" textAnchor="middle" className="fill-[var(--accent)]" fontFamily="var(--font-jetbrains)" fontSize="10">policy update</text>
          <text x="775" y="186" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">gradient step</text>
          ...
          <text x="203" y="143" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">env data</text>

          {/* Actors → Replay Memory */}
          <path d="M400 150 L466 150" className="stroke-[var(--accent)]" strokeWidth="1.5" markerEnd="url(#arr-accent)" />
          <text x="433" y="143" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">experiences</text>

          {/* Replay Memory → Learner */}
          <path d="M640 150 L706 150" className="stroke-[var(--accent)]" strokeWidth="1.5" markerEnd="url(#arr-accent)" />
          <text x="673" y="143" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">minibatches</text>
          ...
          <text x="548" y="300" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="9">broadcast model weights</text>
          ...
          <text x="648" y="268" textAnchor="middle" className="fill-[var(--text-muted)]" fontFamily="var(--font-jetbrains)" fontSize="8">priorities</text>
        </svg>
      </div>
